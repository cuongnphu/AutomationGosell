package com.gosell.listener;

import com.gosell.helper.PdfHelper;
...
public class TestListener implements ITestListener {
    ...
    public TestListener() throws IOException {
        ...
        nxgReportDir = new File(System.getProperty("user.dir") + "//..//Gosell-Report//HTMLReports");
        sPdfReports = new File(System.getProperty("user.dir") + "//..//Gosell-Report//PDFReports");
    ...
    public void onFinish(ITestContext iTestContext) {
        ...
        try {
            ...
            String sTestngReports= System.getProperty("user.dir") + "//..//Gosell-Report//TestNGReports//TestNG_" + sdateTime;
